package com.hlidskialf.android.game.input;
...
public class GamepadView extends View
{
    ...
    public GamepadView(Context context) { this(context,null,0); }
    public GamepadView(Context context, AttributeSet attrs) { this(context,attrs,0); }
    public GamepadView(Context context, AttributeSet attrs, int style)
    {
        super(context,attrs,style);


        PackageManager pm = context.getPackageManager();
        mDistinctMultitouch = pm.hasSystemFeature(PackageManager.FEATURE_TOUCHSCREEN_MULTITOUCH_DISTINCT);
